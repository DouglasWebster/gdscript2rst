...
SetupDialog::SetupDialog( wxWindow *parent )
  ...
  wxStaticLine *divisor1 =
      new wxStaticLine( panel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
  ...
  wxTextCtrl *pythonVersionCtl =
      new wxTextCtrl( panel, wxID_ANY, "dummy python version 3.6"); //std::to_string(parent->GetPythonVersion()), wxDefaultPosition, wxDefaultSize, 0 );
      pythonVersionCtl->SetEditable(false);
  pythonDetailsSizer->Add( pythonVersionCtl, 1, wxALL, 5 );

  wxTextCtrl *pipVersionCtr =
      new wxTextCtrl( panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  ...
  sourceButton->Bind( wxEVT_BUTTON, [ =, this ]( wxCommandEvent &event ) {
    wxFileDialog dialog( this, _( "Godot Project directory" ), "", "",
